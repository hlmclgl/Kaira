    ...
    return (
        <SafeAreaView className="flex-1 flex justify-around bg-black">
            <View className="space-y-2">
                <Text style={{ fontSize: wp(10) }} className="text-center font-bold text-gray-700">Arise</Text>
            ...
            {/* start button */}
            <TouchableOpacity onPress={() => navigation.navigate('AriseAI')} className="bg-emerald-600 mx-5 p-4 rounded-2xl mb-16">
